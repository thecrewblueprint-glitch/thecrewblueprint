...
const powerAwareness = {
  ...
  quiz: [
    ...
    { question: 'Does ETCP make PPDT a required prerequisite for every Entertainment Electrician?', options: ['Yes', 'No; ETCP does not require PPDT before Entertainment Electrician', 'Only at venues'], answer: 1, coaching: 'The useful model is a competency progression, while credentials and employer paths remain separate.' }
  ],
