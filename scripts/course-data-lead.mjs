...
const departmentLeadCourses = [
  ...
  leadCourse({
    ...
    verifyChecks: ['System matches the current approved plan.', 'Equipment and environment fit the assigned use.', 'Only authorized people perform restricted tasks.', 'Required inspections, measurements, and tests have named results.', 'Code, venue, and source constraints have responsible confirmation.', 'Unsafe or uncertain conditions remain isolated and visible.'],
