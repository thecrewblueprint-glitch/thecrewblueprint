...
check(reviewFiles.length === 46, `expected 46 owner-review routes, found ${reviewFiles.length}`);
...
check(structuredCourses === 21, `expected 21 structured tiered courses, found ${structuredCourses}`);
