(function(){
  ...
  function start(){
    ...
    var footer=document.createElement('footer');footer.className='cb-course-shell-footer';footer.innerHTML='<div class="cb-course-footer-brand"><span class="cb-course-footer-mark" aria-hidden="true"></span><span>The Crew <span>Blueprint</span></span></div><nav class="cb-course-footer-links" aria-label="Footer"><a href="../about.html">About</a><a href="../courses.html">Courses</a><a href="../terms.html">Terms</a><a href="../privacy.html">Privacy</a><a href="../contact.html">Contact</a></nav><p>&copy; 2026 The Crew Blueprint, a brand of Deadhang Labor LLC. All rights reserved.</p>';document.body.appendChild(footer);
  }
