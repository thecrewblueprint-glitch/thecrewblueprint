(function(){
  ...
  function start(){
    ...
    var exit=document.createElement('a');exit.className='cb-course-shell-exit';exit.href=oldExit?oldExit.getAttribute('href'):'../learn.html';exit.textContent=oldExit?oldExit.textContent.trim():'← Exit Course';
    ...
    var footer=document.createElement('footer');footer.className='cb-course-shell-footer';footer.innerHTML='<div class="cb-course-footer-brand"><img class="cb-course-footer-mark" src="../images/crew-blueprint-mark.png" alt=""><span>The Crew <span>Blueprint</span></span></div><nav class="cb-course-footer-links" aria-label="Footer"><a href="../index.html">Home</a><a href="../start.html">Start Here</a><a href="../learn.html">Courses</a><a href="../field.html">Field Skills</a><a href="../contexts.html">Context Labs</a><a href="../terms-and-conditions.html">Terms</a><a href="../privacy-policy.html">Privacy</a></nav><p>&copy; 2026 The Crew Blueprint, a brand of Deadhang Labor LLC. All rights reserved.</p>';document.body.appendChild(footer);
  }
