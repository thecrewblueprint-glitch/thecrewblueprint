  ...
  const assessmentBanks={
    ...
    'systems-thinking':{
      ...
      questions:[
        ...
        {prompt:'A case label says stage left, but the verbal direction you just heard points it toward stage right. What should you do?',choices:['Follow the verbal direction because it is newer than the label','Pause the move, keep the label intact, and confirm the destination with the responsible person','Take it to a neutral staging area and let the next crew decide','Change the label to stage right so the case matches the latest direction'],answer:1},
