...
check(consentRuntime.includes('Limitation of Liability'), 'runtime is missing the Limitation link');
...
if (errors.length) {
  ...
  console.log('- unchecked dual acknowledgment and explicit assent verified');
